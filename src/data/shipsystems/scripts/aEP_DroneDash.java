...
import combat.util.aEP_Tool.Util;
...
{
  static final float MAX_SPEED_BONUS = 300f;
  static final float TURN_RATE_BONUS = 250f;
  static final float ROTATE_SPEED = 20f;
  static final float END_BUFF_TIME = 1f;
  static final float END_TURN_RATE_BONUS = 200f;
  static final float ENGINE_DAMAGE_TAKEN = 0.25f;
  ...
  public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
    ...
    stats.getEngineDamageTakenMult().modifyMult(id, ENGINE_DAMAGE_TAKEN);
