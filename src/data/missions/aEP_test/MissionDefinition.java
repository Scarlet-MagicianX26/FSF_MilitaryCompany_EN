...
public class MissionDefinition implements MissionDefinitionPlugin
{
  ...
  public void defineMission(MissionDefinitionAPI api) {
    ...
    //主力
    api.addToFleet(FleetSide.PLAYER, "aEP_decomposer_Standard", FleetMemberType.SHIP, "FSF ship 03", false);
    api.addToFleet(FleetSide.PLAYER, "aEP_BiaoBing_Burst", FleetMemberType.SHIP, "FSF ship 05", true);
    api.addToFleet(FleetSide.PLAYER, "aEP_DuiLiu_Standard", FleetMemberType.SHIP, "FSF ship 06", true);
    api.addToFleet(FleetSide.PLAYER, "aEP_NuanChi_Standard", FleetMemberType.SHIP, "FSF ship 10", false);
    ...
    //api.addToFleet(FleetSide.PLAYER, "aEP_HuanLiu_Standard", FleetMemberType.SHIP, "FSF ship", false);
    ...
    //api.addToFleet(FleetSide.PLAYER, "aEP_XiLiu_p_Standard", FleetMemberType.SHIP, "FSF ship 17", false);
    api.addToFleet(FleetSide.PLAYER, "aEP_station3", FleetMemberType.SHIP, "FSF ship 18", false);
