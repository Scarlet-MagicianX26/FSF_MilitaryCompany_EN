...
public class aEP_defense_droneAI implements ShipAIPlugin
{
  ...
  public aEP_defense_droneAI(FleetMemberAPI member, ShipAPI ship) {
    this.ship = ship;
  ...
  public void advance(float amount) {
    ...
    */
    ...
    aEP_Tool.Util.setToPosition(ship, targetLocation, amount);
