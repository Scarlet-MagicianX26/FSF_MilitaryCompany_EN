...
public class aEP_MarkerAnimation implements EveryFrameWeaponEffectPlugin
{
  ...
  static {
    if (smokeColor.isEmpty()) {
      ...
      smokeColor.add(new Color(220, 50, 50, 180));
      smokeColor.add(new Color(150, 100, 100, 180));
      smokeColor.add(new Color(220, 50, 150, 150));
      smokeColor.add(new Color(180, 100, 110, 150));
      smokeColor.add(new Color(200, 100, 100, 120));
      smokeColor.add(new Color(220, 50, 60, 120));
    }
    ...
    if (effectiveLevel > 0.5f) {
      ...
      if (timer > 0.1f) {
        ...
        if (smokeSprites.size() >= 3) {
          ...
          Vector2f size = new Vector2f(12f, 12f);
          Vector2f sizeChange = new Vector2f(10f, 10f);
